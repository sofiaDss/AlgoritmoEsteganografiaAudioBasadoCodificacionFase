...
function [Rx,svr] = ReceptorM4(rutaStego, Ts, n_lsb_Bn, Bn, minS, maxS, rutaSecreto, nombreSecreto)
    ...
    if dirIncrustacion==1        
        ...
        svr=reshape(svr_B1,1,[]);
          ...
          if Numb_B4>0
            Ls_B4=Numb_B4/n_lsb_Bn(4);
            svr_B4=Yppm(res-n_lsb_Bn(4)+1:res,LimI_B4:LimI_B4+Ls_B4-1);
            svr=[svr reshape(svr_B4,1,[])];
          end        
          if Numb_B5>0
            Ls_B5=Numb_B5/n_lsb_Bn(5);
            svr_B5=Yppm(res-n_lsb_Bn(5)+1:res,LimI_B5:LimI_B5+Ls_B5-1);
            svr=[svr reshape(svr_B5,1,[])];
          end
         ...
         while Numb_B1+Numb_B2+Numb_B3+Numb_B4+Numb_B5>Ts
           ...
           Ls_B5=Numb_B5/n_lsb_Bn(5);
           svr_B5=Yppm(res-n_lsb_Bn(5)+1:res,LimS_B5-Ls_B5+1:LimS_B5);
           svr=reshape(svr_B5,1,[]);

           if Numb_B4>0
               Ls_B4=Numb_B4/n_lsb_Bn(4);
               svr_B4=Yppm(res-n_lsb_Bn(4)+1:res,LimS_B4-Ls_B4+1:LimS_B4);
