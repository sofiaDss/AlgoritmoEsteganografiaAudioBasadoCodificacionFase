...
%         for duracionAudioSecreto=1:2:16 
            ...
            %------------------- TRANSMISOR
            [ruta_stego,n_lsb_Bn,Bn,svLim,minS,maxS,SNR,NMSE,SSIM,PEAQodg]=TransmisorM3(...
            ...
            archivosTable(iter,:)=sprintf('%s_lsb%d%d%d_%s.wav',nombre_portada(1:end-4),n_lsb_Bn(1),n_lsb_Bn(2),n_lsb_Bn(3),nombre_secreto(1:end-4));
...
T=table(archivosTable,fsTable,nlsbB1Table,nlsbB2Table,nlsbB3Table,bitsIncrusTable,fssTable,berTable,snrTable,nmseTable,ssimTable,peaqOdgTable);
T.Properties.VariableNames={'Archivo', 'Fs','n_lsb1','n_lsb2','n_lsb3', 'bitsIncrustados','Fss','BER', 'SNR','NMSE','SSIM','PEAQ-ODG'};
writetable(T,'../informeIncrustacion.xlsx','sheet','Metodo3','Range','A2');
